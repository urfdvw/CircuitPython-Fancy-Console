...
export const VariableDisp = ({ connectedVariables, variableName, displayName }) => {
    return (
        <>
            <b>{displayName}:</b>
...
export const CreateVariableDisp = ({ open, onClose, setWidgets }) => {
    ...
    return (
        <Dialog open={open}>
            ...
            <DialogContent>
                <DialogContentText>
                    Please make sure there is a connected variable created in your microcontroller code.
                </DialogContentText>
                <TextField
                    autoFocus
                    margin="dense"
