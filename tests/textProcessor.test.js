...
describe("test matchesInBetween()", () => {
    ...
    it("empty case", () => {
        expect(
            matchesInBetween("", constants.CV_JSON_START, constants.CV_JSON_END)
        ).toStrictEqual([]);
    });
    it("null case", () => {
        expect(
...
describe("test splitByInBetween()", () => {
    ...
    it("empty case", () => {
        expect(
            splitByInBetween("", constants.CV_JSON_START, constants.CV_JSON_END)
        ).toStrictEqual([]);
    });
    it("null case", () => {
        expect(
...
describe("test removeInBetween()", () => {
    ...
    it("empty case", () => {
        expect(
            removeInBetween("", constants.CV_JSON_START, constants.CV_JSON_END)
        ).toStrictEqual("");
    });
    it("null case", () => {
        expect(
